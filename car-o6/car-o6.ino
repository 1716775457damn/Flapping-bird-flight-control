...
void setup()
{
  ...
  // 初始化转向舵机（GPIO17）
  steeringServo.setup(50, 10, 12); // 使用通道12
  steeringServo.attachPin(17);     // 使用GPIO17
  steeringServo.setScale(0.7);     // 限制转向角度
  steeringServo.write(0, -1, 1);
